...
<nav class="navbar navbar-dark bg-light samp-navbar navbar-expand-lg  fixed-top">
  ...
  <a class="navbar-brand" href="index.php"><img src="img/logo1.png" alt="Sampurn Kirtiman" height="100px"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="work.php">Our Work <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
